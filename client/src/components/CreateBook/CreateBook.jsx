      ...
      <div className="contentCreateBook">
            ...
            <div className="formBackx">
                <div className="mantengo">
                    ...
                    <button className="buttonDeleteBook" onClick={() => {
                      setNewBook({
                        ...newBook,
                    ...
                    : null}
                    <button className="buttonDeleteBook" disabled={newBook.categories.length === 0}
                    onClick={() => deleteCategory(newBook, setNewBook, setCatSel)}>Delete Category</button>
                </div>
